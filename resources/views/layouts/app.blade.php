...
<body>
                ...
                <div class="app-header__logo">
                    ...
                    <div class="logo-src mb-3">
                        <a class="navbar-brand" href="{{ url('/') }}">
                            <img src="{{ asset('images/logo/dark.png') }}" width="150px">
                        </a>
                    </div>
                            ...
                            <div class="app-footer__inner">
                                <div class="app-footer-left">
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a target="_blank"
                                                href="https://github.com/DashboardPack/architectui-html-theme-free"
    ...
    <script src="/jQuery-3.3.1/jquery-ui.js"></script>
